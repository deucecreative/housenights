...
export const clientBuildEnv: { [K in ConfigKeys]: string } = {
    ...
    'VITE_APP_THEME_COLOR': import.meta.env.VITE_APP_THEME_COLOR,
    'VITE_APP_BACKGROUND_COLOR': import.meta.env.VITE_APP_BACKGROUND_COLOR,
    'VITE_APP_FONT_FAMILY': import.meta.env.VITE_APP_FONT_FAMILY,
    'VITE_APP_HEADING_FONT_FAMILY': import.meta.env.VITE_APP_HEADING_FONT_FAMILY,
    'VITE_APP_FONT_CSS_URL': import.meta.env.VITE_APP_FONT_CSS_URL,
